...
function TorbuttonLogger() {
    Services.scriptloader.loadSubScript(kDefaultPreferences, this);

    // Register observer
    Services.prefs.addObserver("extensions.torbutton", this, false);

    this.loglevel = Services.prefs.getIntValue("extensions.torbutton.loglevel");
    this.logmethod = Services.prefs.getIntValue("extensions.torbutton.logmethod");
